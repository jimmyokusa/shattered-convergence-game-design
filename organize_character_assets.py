"""Create the per-character asset directory skeleton in ~/Pictures and the repo."""

import os
import sys

# Console output contains emoji; Windows defaults to cp1252, which cannot
# encode them. sys.stdout is typed as the broader TextIO, which does not
# expose reconfigure().
...
def setup_character_directories() -> None:
    """Create the picture and project asset directories for every character."""
